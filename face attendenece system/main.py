...
raghav_image = face_recognition.load_image_file("photos/raghav.jpg")
raghav_encoding = face_recognition.face_encodings(raghav_image)[0]

mehta_image = face_recognition.load_image_file("photos/mehta.jpg")
mehta_encoding = face_recognition.face_encodings(mehta_image)[0]
